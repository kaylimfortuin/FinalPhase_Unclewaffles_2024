...
<body data-bs-spy="scroll" data-bs-target=".navbar">
                ...
                <div class="col-lg-8">
                    <form id="container" class="row g-3 p-lg-5 p-4 bg-white theme-shadow" action="form_handler.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-lg-12">
                            ...
                            <div class="form-group col-lg-12 d-grid">
                                <button class="btn btn-brand" style="width: 107.66px;" onclick="uploadFile()">Upload</button>
                            </div>
                            <br>
            ...
            <div class="row justify-content-between align-items-center">
                <div class="col-lg-6" data-aos="fade-down" data-aos-delay="50">
                    <video autoplay muted loop id="myVideo">
                        <source src="/Videos/CTU - What we offer.mp4" type="video/mp4">
                    </video>
                </div>
    ...
    <section class="section-padding bg-light" id="contact">
        <div class="container">
            ...
            <div class="row justify-content-center" data-aos="fade-down" data-aos-delay="250">
                <div class="col-lg-8">
                    <form action="https://formspree.io/f/xqkrggvd" class="row g-3 p-lg-5 p-4 bg-white theme-shadow" method="post">
                        <div class="form-group col-lg-6">
                        ...
                        <div class="form-group col-lg-12">
                            <input type="text" class="form-control" placeholder="Student number" required>
                        </div>
                        <div class="form-group col-lg-12">
            ...
            <div class="container">
                <div class="row gy-5">
                    <div class="col-lg-3 col-sm-6">
                        <a href="#hero"><img src="/images/CTU-Students.png" alt="" width="100" height="100"></a>
                        <div class="line"></div>
                        <div class="social-icons">
                            <a href="https://www.instagram.com/ctutrainingsolutions/" target="_blank"><i class="ri-instagram-fill"></i></a>
                            <a href="https://www.facebook.com/CTUTrainingSolutions" target="_blank"><i class="ri-facebook-fill"></i></a>
                            <a href="https://twitter.com/CTU_Chatz" target="_blank"><i class="ri-twitter-fill"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
